 ...
 * @LastEditTime: 2025-12-12 18:50:04
...
import FieldConfiguration, {
  DEFAULT_FIELDS,
} from "../../components/fields/FieldConfiguration";
      ...
      if (result.success) {
        ...
        if (
          ...
          !result.templates.some(
            (t: CloudTemplate) => t.name === cloudTemplateName
          )
        ) {
  ...
  const autoConfigureFields = async () => {
    ...
    try {
      ...
      if (result.success && result.fields) {
        const autoFields: FieldConfig[] = result.fields.map(
